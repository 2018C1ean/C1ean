...
public class PersonalPageFragment extends Fragment {
    ...
    private User user;
    private RelativeLayout add_location, account_manage, feedback, help, share, about, check_for_update, give_a_paise, contact_us;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        add_location = view.findViewById(R.id.location_line);
